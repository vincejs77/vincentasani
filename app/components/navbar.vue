      ...
      <UContainer class="flex items-center justify-between py-4">
        <div>
          ...
          -->
            ...
            <span class="absolute left-10 sm:left-10">
              <ClientOnly>
                <div
                  v-show="useGlobalStore().$state.isLoadingPage"
                  class="h-16 w-16"
                >
                  <Vue3Lottie
          ...
          <ClientOnly>
            <UTooltip text="Theme">
              <button
                type="button"
                @click="$toggleTheme()"
                class="rounded-md bg-gray-200 p-2 text-gray-500 dark:bg-gray-800 dark:bg-opacity-10 dark:text-gray-200"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
